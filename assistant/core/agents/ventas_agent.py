...
from schemas.ventas.carreras import DataCarrerasModel
...
def initialize_agent():
    ...
    carreras_instance: DataCarrerasModel = fetch_carreras()
    agent.carreras: DataCarrerasModel  = carreras_instance
